          ...
          <div class="mx-auto max-w-2xl">
            <div class="max-w-lg">
              ...
              <div class="mt-24 sm:mt-32 lg:mt-16">
                <nuxt-link to="/updates" class="inline-flex space-x-6">
                  <span
                  ...
                  <span class="inline-flex items-center space-x-2 text-sm font-medium leading-6 text-gray-600">
                    <span>Alpha testing v0.1.0</span>
              ...
              <h1 class="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                Supercharge your window quoting
              </h1>
              <p class="mt-6 text-lg leading-8 text-gray-600">
                EzEval is the fastest, most accurate and reliable way to get a window cleaning quote to your customers.
                Enjoy the best project evaluation tool there is, developed by window cleaners for window cleaners.
              </p>
              <div class="mt-10 flex items-center gap-x-6">
                ...
                <nuxt-link to="/demo" class="text-sm font-semibold leading-6 text-gray-900">
          ...
          <div class="shadow-lg md:rounded-3xl">
            <div class="bg-indigo-500 [clip-path:inset(0)] md:[clip-path:inset(0_round_theme(borderRadius.3xl))]">
              <div
                ...
                aria-hidden="true"></div>
              <!-- image window -->
              <div v-if="false" class="relative px-6 pt-8 sm:pt-16 md:pl-16 md:pr-0">
